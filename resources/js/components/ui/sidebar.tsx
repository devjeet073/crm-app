...
function SidebarMenuButton({
  ...
  // Only mount the tooltip when the sidebar is icon-collapsed.
  // Using `hidden` on TooltipContent still lets Radix open the popup and set
  // data-state=open on the trigger, which breaks expanded hover styles.
