...
import { index as usersIndex, show as usersShow, update as usersUpdate, edit as usersEdit } from '@/routes/users';
...
export default function UserEdit({ user, teams, types }: PageProps) {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Edit', href: usersEdit.url(user) },
    ];
            ...
            <div className="flex flex-1 flex-col gap-6 p-4">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid gap-6 lg:grid-cols-2">
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Basic identity fields for this user
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="space-y-1.5">
                                        <Label htmlFor="salutation_name">
                                            Salutation
                                        </Label>
                                        <Select
                                            value={data.salutation_name}
                                            onValueChange={(v) =>
                                                setData('salutation_name', v)
                                            }
                                        >
                                            <SelectTrigger id="salutation_name">
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Account type, status, and team assignment
                                    (admin only)
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <Select
                                        ...
                                        onValueChange={(v) =>
                                            setData('default_team_id', v)
                                        }
                                    >
                                        <SelectTrigger id="default_team_id">
                    ...
                    <div className="flex gap-3">
                        <Button variant="outline" type="button" onClick={() => router.visit(usersIndex.url())}>
                        ...
                        <Button
                            variant="outline"
                            type="button"
                            onClick={() => router.visit(usersShow.url(user))}
                        >
                            Cancel
                        </Button>
                    </div>
