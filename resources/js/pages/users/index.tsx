        ...
        () => [
            {
                ...
                cell: ({ row }) => (
                    <a
                        href={usersShow.url(row.original)}
                    ...
                    >
                        <Avatar className="h-7 w-7 text-[10px]">
                            ...
                            <AvatarFallback
                                style={{
                                    backgroundColor:
                                        row.original.avatar_color ?? '#6366f1',
                                }}
            ...
            },
            {
                ...
                cell: ({ row }) => (
                    <Badge
                        variant={TYPE_BADGE[row.original.type] ?? 'secondary'}
                    >
                        {row.original.type}
                    </Badge>
                ),
                    ...
                    return (
                        <div className="flex items-center justify-end gap-1">
                            ...
                            <DeleteAlertDialog
                                ...
                                onConfirm={() =>
                                    router.delete(usersDestroy.url(user))
                                }
                            />
                        </div>
                    );
