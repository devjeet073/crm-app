...
import type { BreadcrumbItem, Document, Auth } from '@/types';
...
function DetailRow({
    ...
    return (
        <div className="grid grid-cols-3 gap-2 border-b py-3 last:border-b-0">
    ...
    return (
        <>
            ...
            <div className="flex flex-1 flex-col gap-6 p-4">
                ...
                {/* Status badge */}
                <span
                    className={`inline-flex w-fit items-center rounded-full px-3 py-1 text-sm font-medium ${STATUS_COLORS[document.status] ?? 'bg-muted text-muted-foreground'}`}
                >
                    {document.status}
                </span>
                        ...
                        <DetailRow
                            ...
                            value={
                                document.publish_date
                                    ? format(
                                          new Date(document.publish_date),
                                          'dd MMM yyyy',
                                      )
                                    : null
                            }
