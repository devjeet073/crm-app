...
import {
    ...
    show as teamsShow,
    edit as teamsEdit,
    destroy as teamsDestroy,
} from '@/routes/teams';
import {
    assignUser as teamsAssignUser,
    revokeUser as teamsRevokeUser,
} from '@/routes/teams';
import type { BreadcrumbItem, Team, CrmUser, Role } from '@/types';

type PageProps = {
    team: Team & {
        users: (CrmUser & { pivot: { role: string | null } })[];
        roles: Role[];
    };
};
...
export default function TeamShow({ team }: PageProps) {
    ...
    function handleAssignUser(e: React.FormEvent) {
        ...
        router.post(
            teamsAssignUser.url(team),
            { user_id: assignUserId, role: assignUserRole || null },
            {
                preserveScroll: true,
                onSuccess: () => {
                    setAssignUserId('');
                ...
                <div className="flex flex-wrap items-center justify-between gap-4">
                    ...
                    <div className="flex gap-2">
                        ...
                        <DeleteAlertDialog
                            ...
                            onConfirm={() =>
                                router.delete(teamsDestroy.url(team), {
                                    onSuccess: () =>
                ...
                <div className="grid gap-6 lg:grid-cols-2">
                            ...
                            >
                                <div className="flex gap-2">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) =>
                                            setAssignUserRole(e.target.value)
                                        }
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                ACL roles applied to this team's members
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            {team.roles.length === 0 ? (
