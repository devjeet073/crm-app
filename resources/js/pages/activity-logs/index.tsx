        ...
        () => [
            ...
            },
            {
                ...
                cell: ({ row }) => (
                    <Badge
                        variant={
                            ACTION_BADGE_MAP[row.original.action] || 'outline'
                        }
                    >
                        {row.original.action}
                    </Badge>
                ...
                cell: ({ row }) => (
                    <span className="text-sm text-muted-foreground">
                        {row.original.subject_type
                            ? row.original.subject_type.split('\\').pop()
                            : 'N/A'}
                    </span>
                ),
            },
    ...
    return (
        <>
            ...
            <div className="flex flex-1 flex-col gap-6 p-4">
                ...
                <DataTable
                    tableId="activity-logs-index-table"
                    columns={columns}
                    data={logs.data}
                                        ...
                                        <tbody className="divide-y">
                                            {Array.from(
                                                ...
                                                <tr key={key}>
                                                    ...
                                                    <td className="bg-red-50/50 p-2 text-red-600/80">
                                                        {JSON.stringify(
                                                            selectedLog
                                                                .old_values?.[
                                                                key
                                                    ...
                                                    <td className="bg-green-50/50 p-2 text-green-600/80">
                                                        {JSON.stringify(
                                                            selectedLog
                                                                .new_values?.[
                                                                key
